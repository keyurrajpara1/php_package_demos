					  ...
					  <tbody>
					  	<?php 
					  		foreach ($chatrooms as $key => $chatroom) {
					  			...
					  			echo '<tr><td valign="top"><div><strong>'.$from.'</strong></div><div>'.$chatroom['message'].'</div><td align="right" valign="top">'.date("d/m/Y h:i:s A", strtotime($chatroom['created_at'])).'</td></tr>';
					  		}
					  	 ?>
					  </tbody>
					</table>
